      ...
      <footer className="bg-gray-900 text-white py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Company Info */}
            <div>
              <h3 className="text-lg font-semibold mb-4">{landingPageContent.company?.name || 'HerbalMed'}</h3>
              <p className="text-gray-300 text-sm mb-4">
                {landingPageContent.company?.description || 'Your trusted source for premium herbal medicines and natural healing solutions.'}
              </p>
              <div className="space-y-2 text-sm text-gray-300">
                <p>{landingPageContent.company?.address || '123 Wellness Street, Green City, State 12345'}</p>
                <p>{landingPageContent.company?.phone || '(555) 123-4567'}</p>
                <p>{landingPageContent.company?.email || 'info@herbalmed.com'}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">
                {landingPageContent.company?.hours || 'Mon-Fri: 9AM-6PM, Sat: 10AM-4PM'}
              </p>
            </div>
          </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-6 text-center">
            <p className="text-gray-300 text-sm">
              {landingPageContent.sections?.footer?.copyright || `© 2024 ${landingPageContent.company?.name || 'HerbalMed'}. All rights reserved.`}
            </p>
          </div>
        </div>
      </footer>
